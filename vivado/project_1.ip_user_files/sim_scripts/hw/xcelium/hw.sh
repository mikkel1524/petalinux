...
#
# Script generated by Vivado on Thu May 29 10:14:48 CEST 2025
...
#
# Usage        : hw.sh
#                hw.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                hw.sh [-reset_run]
#                hw.sh [-reset_log]
#                hw.sh [-help]
#
...
#                script (type 'hw.sh -help' for more information).
#
...
design_libs_elab="-libname xilinx_vip -libname xpm -libname axi_infrastructure_v1_1_0 -libname axi_vip_v1_1_20 -libname processing_system7_vip_v1_0_22 -libname xil_defaultlib -libname axi_lite_ipif_v3_0_4 -libname lib_cdc_v1_0_3 -libname interrupt_control_v3_1_5 -libname axi_gpio_v2_0_36 -libname xlconstant_v1_1_9 -libname proc_sys_reset_v5_0_16 -libname smartconnect_v1_0 -libname axi_register_slice_v2_1_34 -libname xilinx_vip -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xilinx_vip xpm axi_infrastructure_v1_1_0 axi_vip_v1_1_20 processing_system7_vip_v1_0_22 xil_defaultlib axi_lite_ipif_v3_0_4 lib_cdc_v1_0_3 interrupt_control_v3_1_5 axi_gpio_v2_0_36 xlconstant_v1_1_9 proc_sys_reset_v5_0_16 smartconnect_v1_0 axi_register_slice_v2_1_34)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "hw.sh - Script generated by export_simulation (Vivado v2024.2.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./hw.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  xmvlog -work xilinx_vip $xmvlog_opts -sv +incdir+"../../../../project_1.gen/sources_1/bd/hw/ipshared/ec67/hdl" +incdir+"../../../../project_1.gen/sources_1/bd/hw/ipshared/8391/hdl" +incdir+"../../../../project_1.gen/sources_1/bd/hw/ipshared/f0b6/hdl/verilog" +incdir+"../../../../project_1.gen/sources_1/bd/hw/ipshared/0127/hdl/verilog" +incdir+"/home/ja/vivado/Vivado/2024.2/data/xilinx_vip/include" \
  ...
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../project_1.gen/sources_1/bd/hw/ipshared/ec67/hdl" +incdir+"../../../../project_1.gen/sources_1/bd/hw/ipshared/8391/hdl" +incdir+"../../../../project_1.gen/sources_1/bd/hw/ipshared/f0b6/hdl/verilog" +incdir+"../../../../project_1.gen/sources_1/bd/hw/ipshared/0127/hdl/verilog" +incdir+"/home/ja/vivado/Vivado/2024.2/data/xilinx_vip/include" \
  ...
  xmvlog -work axi_infrastructure_v1_1_0 $xmvlog_opts +incdir+"../../../../project_1.gen/sources_1/bd/hw/ipshared/ec67/hdl" +incdir+"../../../../project_1.gen/sources_1/bd/hw/ipshared/8391/hdl" +incdir+"../../../../project_1.gen/sources_1/bd/hw/ipshared/f0b6/hdl/verilog" +incdir+"../../../../project_1.gen/sources_1/bd/hw/ipshared/0127/hdl/verilog" +incdir+"/home/ja/vivado/Vivado/2024.2/data/xilinx_vip/include" \
  "../../../../project_1.gen/sources_1/bd/hw/ipshared/ec67/hdl/axi_infrastructure_v1_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work axi_vip_v1_1_20 $xmvlog_opts -sv +incdir+"../../../../project_1.gen/sources_1/bd/hw/ipshared/ec67/hdl" +incdir+"../../../../project_1.gen/sources_1/bd/hw/ipshared/8391/hdl" +incdir+"../../../../project_1.gen/sources_1/bd/hw/ipshared/f0b6/hdl/verilog" +incdir+"../../../../project_1.gen/sources_1/bd/hw/ipshared/0127/hdl/verilog" +incdir+"/home/ja/vivado/Vivado/2024.2/data/xilinx_vip/include" \
  "../../../../project_1.gen/sources_1/bd/hw/ipshared/0f82/hdl/axi_vip_v1_1_vl_rfs.sv" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work processing_system7_vip_v1_0_22 $xmvlog_opts -sv +incdir+"../../../../project_1.gen/sources_1/bd/hw/ipshared/ec67/hdl" +incdir+"../../../../project_1.gen/sources_1/bd/hw/ipshared/8391/hdl" +incdir+"../../../../project_1.gen/sources_1/bd/hw/ipshared/f0b6/hdl/verilog" +incdir+"../../../../project_1.gen/sources_1/bd/hw/ipshared/0127/hdl/verilog" +incdir+"/home/ja/vivado/Vivado/2024.2/data/xilinx_vip/include" \
  "../../../../project_1.gen/sources_1/bd/hw/ipshared/8391/hdl/processing_system7_vip_v1_0_vl_rfs.sv" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../project_1.gen/sources_1/bd/hw/ipshared/ec67/hdl" +incdir+"../../../../project_1.gen/sources_1/bd/hw/ipshared/8391/hdl" +incdir+"../../../../project_1.gen/sources_1/bd/hw/ipshared/f0b6/hdl/verilog" +incdir+"../../../../project_1.gen/sources_1/bd/hw/ipshared/0127/hdl/verilog" +incdir+"/home/ja/vivado/Vivado/2024.2/data/xilinx_vip/include" \
  ...
  xmvhdl -work axi_gpio_v2_0_36 -V93 $xmvhdl_opts \
  ...
  xmvlog -work xlconstant_v1_1_9 $xmvlog_opts +incdir+"../../../../project_1.gen/sources_1/bd/hw/ipshared/ec67/hdl" +incdir+"../../../../project_1.gen/sources_1/bd/hw/ipshared/8391/hdl" +incdir+"../../../../project_1.gen/sources_1/bd/hw/ipshared/f0b6/hdl/verilog" +incdir+"../../../../project_1.gen/sources_1/bd/hw/ipshared/0127/hdl/verilog" +incdir+"/home/ja/vivado/Vivado/2024.2/data/xilinx_vip/include" \
  ...
  xmvlog -work smartconnect_v1_0 $xmvlog_opts -sv +incdir+"../../../../project_1.gen/sources_1/bd/hw/ipshared/ec67/hdl" +incdir+"../../../../project_1.gen/sources_1/bd/hw/ipshared/8391/hdl" +incdir+"../../../../project_1.gen/sources_1/bd/hw/ipshared/f0b6/hdl/verilog" +incdir+"../../../../project_1.gen/sources_1/bd/hw/ipshared/0127/hdl/verilog" +incdir+"/home/ja/vivado/Vivado/2024.2/data/xilinx_vip/include" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts -sv +incdir+"../../../../project_1.gen/sources_1/bd/hw/ipshared/ec67/hdl" +incdir+"../../../../project_1.gen/sources_1/bd/hw/ipshared/8391/hdl" +incdir+"../../../../project_1.gen/sources_1/bd/hw/ipshared/f0b6/hdl/verilog" +incdir+"../../../../project_1.gen/sources_1/bd/hw/ipshared/0127/hdl/verilog" +incdir+"/home/ja/vivado/Vivado/2024.2/data/xilinx_vip/include" \
  ...
  xmvlog -work axi_register_slice_v2_1_34 $xmvlog_opts +incdir+"../../../../project_1.gen/sources_1/bd/hw/ipshared/ec67/hdl" +incdir+"../../../../project_1.gen/sources_1/bd/hw/ipshared/8391/hdl" +incdir+"../../../../project_1.gen/sources_1/bd/hw/ipshared/f0b6/hdl/verilog" +incdir+"../../../../project_1.gen/sources_1/bd/hw/ipshared/0127/hdl/verilog" +incdir+"/home/ja/vivado/Vivado/2024.2/data/xilinx_vip/include" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.hw xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.hw -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log hw_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./hw.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: hw.sh [-help]\n\
Usage: hw.sh [-step]\n\
Usage: hw.sh [-lib_map_path]\n\
Usage: hw.sh [-reset_run]\n\
Usage: hw.sh [-reset_log]\n\
Usage: hw.sh [-keep_index]\n\
Usage: hw.sh [-noclean_files]\n\n\
